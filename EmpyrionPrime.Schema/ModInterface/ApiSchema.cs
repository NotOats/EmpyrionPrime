...
namespace EmpyrionPrime.Schema.ModInterface
{
    ...
    {
        /// <summary>
        /// A list of ModInterface Api Events with associated argument types.
        /// </summary>
        ...
        /// <summary>
        /// A list of ModInterface ApiRequests
        /// </summary>
        ...
        public readonly static IReadOnlyDictionary<CmdId, Type> CommandIdTypeMap = 
            ApiRequests.ToDictionary(x => x.CommandId, x => x.ArgumentType)
            .Union(ApiEvents)
